      ...
      <Layout isDarkMode={theme?.darkMode ?? false}>
        <div className="mx-6 pt-8 pb-5 md:mx-12 lg:pt-20">
          <div className="mx-auto max-w-screen-lg">
            ...
            <div className="mt-4 h-[calc(100vh-275px)] overflow-y-auto overflow-x-hidden rounded-lg bg-white px-6 pt-6 shadow-light">
              ...
              <div className="rounded-b-lg bg-accent-400 p-6 text-white">
